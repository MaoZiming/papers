...
* Pessimistic 
    ...
    * Cons: unavailability
        * Difficult to handle involuntary disconnection (i.e. if it held a lock) 
...
* Optimistic 
    ...
    * Cons: conflicting writes, relies on resolution protocol  
    * Rational of using this: chance of conflicts is low because **low degree of write share in UNIX**
